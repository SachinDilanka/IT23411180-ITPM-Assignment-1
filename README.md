IT3040 Assignment 1 – Playwright Automation (TypeScript)
This repository contains automated test cases for the SwiftTranslator web application (Singlish → Sinhala) using Playwright with TypeScript. The suite validates various translation scenarios to ensure accuracy and application stability.
...
Bash
git clone https://github.com/SachinDilanka/IT23411180-ITPM-Assignment-1
cd ITPM
...
This will execute all 35 test scenarios (including positive and negative cases) across configured browsers:

Bash
npx playwright test
Run with UI Mode
To interactively view the tests as they run:
...
Notes
Language: Developed using TypeScript for better type safety and maintainability.
...
Repository Link
The GitHub repository is publicly accessible at: https://github.com/SachinDilanka/IT23411180-ITPM-Assignment-1
